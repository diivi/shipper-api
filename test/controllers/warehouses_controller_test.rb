...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference("Warehouse.count") do
      post warehouses_url, params: { warehouse: { location: @warehouse.location, max_items: @warehouse.max_items, name: @warehouse.name } }, as: :json
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { location: @warehouse.location, max_items: @warehouse.max_items, name: @warehouse.name } }, as: :json
    assert_response :success
  end
